...
namespace Sistema.Datos.Migrations
{
    ...
    [Migration("20200729200238_ChangeColumnEmailForUsername")]
    partial class ChangeColumnEmailForUsername
    {
            ...
            modelBuilder.Entity("Sistema.Entidades.Factura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Por pagar",
                            FechaEmision = new DateTime(2020, 7, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            NumeroFactura = "001"
                        });
                });
